...
| P0-2 | **Restate the record everywhere**: spec §3/§6, handoff, verdict doc all updated to corrected numbers (~93% CAGR / 2.03 Sharpe blend; +10–12 CAGR pts vs EW-50, ~+0.05 Sharpe). Re-ratify merge decision #5 explicitly as a judgment call, not a measurement. | F2 (BLOCKER), F15 | No surface, doc, or seed row contains the old 110.5/2.43 record. |
