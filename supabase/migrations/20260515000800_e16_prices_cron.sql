-- THS-40 (E1.6) — Schedule daily price ingest + momentum view refresh.
-- Runs at 21:00 UTC Mon-Fri (15 min before fundamentals; benchmark for the
-- factor pipeline). Same pg_cron + pg_net pattern as earlier migrations.
    ...
    $cron$
      SELECT net.http_post(
        url := (SELECT decrypted_secret FROM vault.decrypted_secrets WHERE name = 'project_url')
               || '/functions/v1/ingest-prices?days=30',
